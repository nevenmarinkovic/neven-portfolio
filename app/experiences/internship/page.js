    ...
    return (
        <div className="space-y-16">
          ...
          <HeroSection
            ...
            text4={"There were many things I learned during my time with FAST. Through multiple demonstrations to the client, I learned how to communicate technical concepts to non-technical people. It was always a balancing act of making sure the client understood the solution while not overwhelming them with technical jargon. "
              ...
              text5={"During my first few weeks at FAST, I often felt overwhelmed by the large system and the many moving parts. "
