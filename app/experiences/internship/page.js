    ...
    return (
        <div className="space-y-16">
          ...
          <HeroSection
            ...
            text2={"There were many things I learned during my time with FAST. Through multiple demonstrations to the client, I learned how to communicate technical concepts to non-technical people. It was always a balancing act of making sure the client understood the solution while not overwhelming them with technical jargon. "
              + "Additionally, I learned how to handle changing requirements. Often times, the client would ask for changes to a process or solution that I had already completed. This forced me to be flexible and adaptible. During my first few weeks at FAST, I often felt overwhelmed by the large system and the many moving parts. "
