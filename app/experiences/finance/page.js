    ...
    <div className="space-y-16">
      ...
      {/* Experience Body with motion */}
        <ExperienceBody
          ...
          alternative4={"Design"}
          text1={"For the first two years at the University of Montana, I worked in the College of Business Deans' Office as a student worker. My responsibilities included assisting with various tasks, including data entry, event planning, and general office duties. One of my routine tasks was inputting payroll data into a spreadsheet for the Finance Director. "
